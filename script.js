document.addEventListener('DOMContentLoaded', () => {
    ...
    // Exercise data structured by topic for Hindi learners
    const topics = {
        ...
        "Past Simple Tense": [
            {
                ...
                questions: [
                    ...
                    { q: "We ate samosas.", id: "pst_translate_samosas" } // Changed from momo
                ]
            },
            {
                title: "Answer the Question",
    ...
    function loadTopic(topicKey) {
        ...
        mainTitle.textContent = topicKey;
        ...
        sections.forEach((section, sectionIdx) => {
            ...
            section.questions.forEach((item, questionIdx) => {
                ...
                textarea.setAttribute('placeholder', 'Type your answer in Hindi here...');
            ...
            clearButton.className = 'submit-section-btn';
            ...
            clearButton.addEventListener('click', () => {
                ...
                alert('Answers for this section have been cleared.');
            });
